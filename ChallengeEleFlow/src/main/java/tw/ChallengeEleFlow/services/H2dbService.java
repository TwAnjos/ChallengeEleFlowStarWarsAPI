...
public class H2dbService {
	...
	public void instantiateH2dbTest() {
		...
		Gson gson = new Gson();
		ReturnPlanetsAPI planetsAPI = gson.fromJson(new String(output.getBytes()), ReturnPlanetsAPI.class);
		...
		//coloca o foreach pra rodar até o next for null
		
		
		//foreach simples
		/*
		 * for (Planets planet : planets) {
		 * iPlanetsRepository.saveAll(Arrays.asList(planet)); }
		 */
	}
